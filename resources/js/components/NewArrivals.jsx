                            ...
                            <form onSubmit={SendEmail}>
                                <div className="modal-body">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <textarea name="body" id="body" placeholder="Body of message" className="form-control" rows="5"></textarea>
                                    </div>
                                    <div className="form-group">
                                        <label style="margin-bottom: 10px;">When to Send:</label>
                                        <div className="form-control">
                                            <span style="margin-right: 20px;">
                                                <input type="radio" name="sending" value="now" checked onChange={(event) => {
                                                    updateMailStatus(prevState => ({...prevState, item: event.currentTarget.value}));
                                                }}/>
                                                <label>Send Now</label>
                                            </span>
                                            <span>
                                                <input type="radio" name="sending" value="later" onChange={(event) => {
                                                    updateMailStatus(prevState => ({...prevState, item: event.currentTarget.value}));
                                                }}/>
                                ...
                                {mailStatus.item === 'later' ? (
                                    <div className={'form-control'}><DateTimePicker onChange={(date) => {
                                        updateMailStatus(prevState => ({...prevStatus, send_date: date}))
                                    }} value={mailStatus.send_date}/></div>
                                ) : null}
                                ...
                                <div className="modal-footer">
                                    ...
                                    <button
                                        /*v-if="!loading && item === 'later'" :disabled="disabled"*/
                                        type="submit" className="btn btn-success">
                                        Send Later
                                    </button>
                                </div>
